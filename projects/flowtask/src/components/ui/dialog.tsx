...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-1/2 top-1/2 z-50 grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4 border border-border/70 bg-popover/90 p-6 shadow-2xl shadow-black/25 backdrop-blur-xl transition-all duration-200 dark:shadow-black/50 sm:rounded-2xl',
